...
2009-08-30
*/
jQuery(function(){jQuery(".translate_block").show()});function google_translate(d,c,e){var a=document.getElementById((("comment"==c)?"div-":"")+c+"-"+e),b;if(!a&&"comment"==c){a=document.getElementById("comment-"+e)}if(a){b="#translate_loading_"+c+"-"+e;if("he"==d){d="iw"}jQuery(a).translate(d,{fromOriginal:true,not:".translate_block",start:function(){jQuery(b).show()},complete:function(){jQuery(b).hide()},error:function(){jQuery(b).hide()}})}jQuery("#translate_popup").slideUp("fast")}function localize_languages(d,c){var e=jQuery("#translate_popup a").get(),a=[],b;for(b in e){a[b]=e[b].title}jQuery.translate(a,"en",(("he"==d)?"iw":d),{complete:function(){a=this.translation;for(b in e){e[b].title=a[b]}jQuery(c).data("localized",true)}})}function show_translate_popup(d,c,h){var a=document.getElementById("translate_popup"),b=jQuery("#translate_button_"+c+"-"+h),g=Math.round(b.offset().left),e=Math.round(b.offset().top+b.outerHeight(true)),f=jQuery(a).position();if(a){if("none"==a.style.display||f.left!=g||f.top!=e){a.style.display="none";jQuery(a).css("left",g).css("top",e);jQuery(a).slideDown("fast");jQuery("#translate_popup .languagelink").each(function(){jQuery(this).unbind("click").click(function(){google_translate(this.lang,c,h);return false})});if("en"!=d&&(!jQuery(a).data("localized"))){localize_languages(d,a)}}else{jQuery(a).slideUp("fast")}}};